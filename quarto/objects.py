...
class Quarto(object):
    ...
    def tournament(self, num_matches=100) -> int:
        ...
        for i in range(num_matches):
            ...
            self.reset()
            if i%2 == 0:
                print(f'Match #{i} completed: {wins_0}-{wins_1} ({draws} draws)')
        print(f'Player 0: {wins_0/num_matches*100:.1f}%')
        print(f'Player 1: {wins_1/num_matches*100:.1f}%')
